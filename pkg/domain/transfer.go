...
type Transfer struct {
	...
	Source        RefLocation  `json:"source" gorm:"foreignKey:SourceID;references:ID"`
	Destination   RefLocation  `json:"destination" gorm:"foreignKey:DestinationID;references:ID"`
}
